...
Current coverage (191 tests across 8 suites):
...
- OPR UI — the `/api/opr/*` endpoints (export builder/documents, return builder/C&E1154/clearance/discharge tracker, send endpoints, bulk scan) have no frontend yet; the SPA does not surface authorisations or shipments.
